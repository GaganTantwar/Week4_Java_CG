...
public class Policy {
    // Private attributes storing policy details
    ...
    // Constructor to initialize all attributes of the insurance policy
    ...
    // Getter for coverage type
    public String getCoverageType() {
        return coverageType;
    }

    // Getter for premium amount
    ...
    // Override toString method to provide string representation of the insurance policy
    @Override
